...
class CustomerPage(Page):
    ...
    update_return_review_menu = Element(css="#\\35 03",describe="升级退货审核菜单")
    ...
    wait_update_return_review_submenu = Element(css="#\\35 03001",describe="升级退货待审核信息子菜单")
    ...
    review_pass_button = Element(css="#Form > div.form-actions > div > button.btn.btn-success",describe="审核通过按钮")
    review_popup_submit_button = Element(css=".layui-layer-btn0",describe="审核弹出框提交按钮")
    update_return_review_button = Element(css=".odd > td:nth-child(11) > a:nth-child(2)",describe="升级退货审核按钮")